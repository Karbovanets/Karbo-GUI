...
public:
    ...
    void retranslateUi(QFrame *OverviewHeaderFrame)
    {
        ...
        m_overviewPoolSizeLabel->setText(QApplication::translate("OverviewHeaderFrame", "0 transactions", nullptr));
        label_9->setText(QApplication::translate("OverviewHeaderFrame", "Pool stats", nullptr));
